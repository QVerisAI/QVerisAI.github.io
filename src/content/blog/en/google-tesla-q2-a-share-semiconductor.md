...
![The image shows the calendar interface of the QVeris Earnings website. The top bar displays the QVeris Earnings logo and navigation. Different companies' earnings dates are marked in different colors, including PPLG on July 14 and BOKH on July 15. July 22 highlights Google's earnings date for GOOGL in green.](../../../assets/blog-google-tesla-q2-a-share-semiconductor-1.png)
...
![The image shows an Alphabet Inc. stock information page. It displays the ticker GOOGL, a current price of $342.35, and a 0.1% gain. Key metrics include revenue of $103.62B and EPS of $9.11, while capex and gross margin are shown as unavailable.](../../../assets/blog-google-tesla-q2-a-share-semiconductor-2.png)
...
![The image shows a Tesla Inc. financial information page. The top section displays the company name, ticker, market type, industry category, and current share price. Key metrics include revenue of $28.248B, up 7.7% year over year, and adjusted EPS of $6.31, below expectations.](../../../assets/blog-google-tesla-q2-a-share-semiconductor-3.png)
