...
## <text color="purple">零额外依赖</text>

<sheet token="WcjHsyhCihjlq3t9My0c0LTBnW8_PKpaWk"/>

装了 OpenClaw 就有 Node.js，不需要任何其他东西。

## <text color="purple">完整的 Agent 行为手册，而非简单封装</text>
...
## <text color="purple">内建安全与质量保障</text>
...
## <text color="purple">手动命令（测试用）</text>
...
<sheet token="WcjHsyhCihjlq3t9My0c0LTBnW8_ZPyO57"/>
