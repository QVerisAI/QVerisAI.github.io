...
![图片展示了 QVeris Hosted MCP 的连接步骤。](../../../assets/blog-qveris-hosted-mcp-coding-agent-guide-2.jpg)
...
![图片展示了使用 QVeris Hosted MCP 的 Client 配置示例。](../../../assets/blog-qveris-hosted-mcp-coding-agent-guide-3.jpg)
